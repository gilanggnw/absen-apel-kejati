...
// Employees data from database.csv
const employeeData = [
  { 
  ...
  { 
    ...
    nama: 'drg. SYARIFAH FITRIA RAMADHANI', 
  ...
  { 
    ...
    nama: 'dr. TASYA AISYAH PRATIWI MAASBA', 
  ...
  { 
    ...
    nama: 'dr. DEVINA MARTINA SWANTARA', 
    jabatan: 'Fungsional Dokter Muda', 
    pangkat: 'III/c (Madya Wira)',
    status: 'aktif'
  },
  { 
    ...
    nama: 'drg. YOHANA VITA MELODY HUTAPEA', 
  ...
  { 
    ...
    nama: 'drg. INNANISA NUR AZMI HANAFI', 
  ...
  { 
    ...
    nama: 'apt. ANA MAULIDA SEPTIANI, S.Farm.', 
